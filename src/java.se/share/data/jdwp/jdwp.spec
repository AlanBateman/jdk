...
(CommandSet EventRequest=15
    (Command Set=1
        ...
        "<p>"
        "When preview features are enabled in the target VM, "
        "<a href=\"#JDWP_Event_Composite_eventKind_FieldAccess\">Field Access</a> and "
        "<a href=\"#JDWP_Event_Composite_eventKind_FieldModification\">Field Modification</a> "
        "events are not generated for an instance field while the object containing "
        "the field is being constructed by the event thread, if the object's class, "
        "or any of its superclasses, has "
        "<a href=\"../../api/java.base/java/lang/reflect/Field.html#isStrictInit()\">"
        "strictly-initialized<sup>PREVIEW</sup></a> instance fields. These "
        "events are also not generated for a static field when the class "
        "declaring the field is being initialized by the event thread and "
        "the class declares strictly-initialized static fields."
        (Out
            ...
            (Repeat events "Events in set."
                (Select Events
                    ...
                    (Alt FieldAccess=JDWP.EventKind.FIELD_ACCESS
                        ...
                        "<p>"
                        "When preview features are enabled in the target VM, this event "
                        "is not generated for an instance field while the object containing "
                        "the field is being constructed by the event thread, if the "
                        "object's class, or any of its superclasses, has "
                        "<a href=\"../../api/java.base/java/lang/reflect/Field.html#isStrictInit()\">"
                        "strictly-initialized<sup>PREVIEW</sup></a> instance fields. This "
                        "event is also not generated for a static field when the class "
                        "declaring the field is being initialized by the event thread and "
                        "the class declares strictly-initialized static fields."
                        "<p>"
